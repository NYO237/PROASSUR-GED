...
const bloc_inscription = document.querySelector(".col-lg-6:not(#bloc_connexion)");
...
async function validerFormulaireInscription(e) {
  ...
  try {
    ...
    inscription_btn.textContent = "Inscription en cours...";
...
async function validerFormulaireConnexion(e) {
  ...
  try {
    ...
    connexion_btn.textContent = "Connexion en cours...";
