...
async function modifier_profil() {
    ...
    const inputTel = document.getElementById('tel_profil');
    ...
    const donneesProfil = {
        ...
        tel_profil: inputTel ? inputTel.value.trim() : '',
    ...
    try {
        ...
        const response = await fetch('/api/profil/enregister_modifications', { // Attention à l'URL exacte de ta route
            method: 'POST',
            headers: {
                ...getAuthHeaders(),
