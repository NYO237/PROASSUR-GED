// public/js/client/client-dash-notifications.js
...
document.addEventListener('DOMContentLoaded', async () => {
  ...
  function carteHTML(n) {
    ...
    // Pas de ligne "Assuré" ici : cette page ne liste que les contrats du
    // client connecté, contrairement à la version employé qui affiche les
    // alertes de tous les assurés.
    return `
      <div class="notif-card ${classePalier} d-flex justify-content-between align-items-center flex-wrap gap-2">
        <div>
          ...
          <div class="text-secondary small">
            Police : ${n.code_bureau || '-'}/${n.num_police || '-'}
          </div>
          <div class="text-secondary small">
  ...
  try {
    ...
    // Met aussi à jour les badges (sidebar + cloche du topbar) présents sur
    // cette page, sans dépendre d'un second script/appel réseau.
