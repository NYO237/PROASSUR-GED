...
CREATE TABLE `prime` (
  ...
  `dta` decimal(15,2) DEFAULT '0.00',
  `carte_rose` decimal(15,2) DEFAULT '0.00',
  `fc_automobile` decimal(15,2) DEFAULT '0.00',
  `tva` decimal(15,2) DEFAULT '0.00',
  `prime_totale` decimal(15,2) NOT NULL,
  `id_document` int NOT NULL,
  PRIMARY KEY (`id_prime`),
  KEY `fk_prime_document` (`id_document`),
  CONSTRAINT `fk_prime_document` FOREIGN KEY (`id_document`) REFERENCES `document` (`id_document`) ON DELETE CASCADE
...
-- Dump completed on 2026-06-11 13:46:09
