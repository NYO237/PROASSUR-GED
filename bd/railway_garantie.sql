...
CREATE TABLE `garantie` (
  ...
  `franchise_limite` varchar(100) DEFAULT NULL,
  `prime_periode` decimal(15,2) NOT NULL,
  `id_document` int NOT NULL,
  PRIMARY KEY (`id_garantie`),
  KEY `fk_garantie_document` (`id_document`),
  CONSTRAINT `fk_garantie_document` FOREIGN KEY (`id_document`) REFERENCES `document` (`id_document`) ON DELETE CASCADE
...
-- Dump completed on 2026-06-11 13:45:50
