...
CREATE TABLE `attestation` (
  ...
  `num_attestation` varchar(50) NOT NULL,
  PRIMARY KEY (`id_document`),
  UNIQUE KEY `num_attestation` (`num_attestation`),
  CONSTRAINT `fk_attestation_document` FOREIGN KEY (`id_document`) REFERENCES `document` (`id_document`) ON DELETE CASCADE
...
-- Dump completed on 2026-06-11 13:45:39
